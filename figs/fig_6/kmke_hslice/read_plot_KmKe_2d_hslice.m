%-------------------------------------------------------
% use plot_KmKe_hslice function to plot KmKe_hslices
%-------------------------------------------------------
% Common params
plots_path = './';
vlevel = -4000;
...
lat_idx_arr = ([133]);
box = "NE_1km";
plot_KmKe_hslice('nesm_2019_2020', vlevel, plots_path, ...
...
plot_KmKe_hslice('nesm_2019_2020_5km', vlevel, plots_path, ...
    lon_min, lon_max, lat_min, lat_max, lat_idx_arr, box, cbar, ref_arrow, cMax, xyskip, ...
    show_xlabel, show_ylabel, show_xticks, show_yticks);
%-------------------------------------------------------
% SM3 1km
...
plot_KmKe_hslice('sm3_2019_2020', vlevel, plots_path, ...
    lon_min, lon_max, lat_min, lat_max, lat_idx_arr, box, cbar, ref_arrow, cMax, xyskip, ...
    show_xlabel, show_ylabel, show_xticks, show_yticks);
%-------------------------------------------------------
