...
type = 'r';
coef = 1;
nesm_1km_gridfile = 'NESM_grd.nc'; 
nesm_5km_gridfile = 'NESM_grd_5km.nc'; 
sm3_1km_gridfile = 'SM3_grd.nc'; 
...
zr_const_lat_1km = load('zr_const_lat_38_5_1km.asc');
zr_const_lat_5km = load('zr_const_lat_38_5_5km.asc');
