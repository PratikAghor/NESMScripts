...
%-------------------------------------------------------
for nt = 1:Nt
    fname = sprintf([dirHR, 'NESM_2019_2020_5km_avg.%05d.nc'], indxRange(nt));
    ...
    fprintf('%e\n', squeeze(kv_t_vslice_const_lat(nt, :, 1, 35)));
...
filename = strcat('nesm_2019_2020_5km_model_kv_t_vslice_const_lat_nt_', string(indxRange(1)), '_', string(indxRange(Nt)), '.nc');
