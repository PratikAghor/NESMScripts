...
VEBF_2d_file = strcat('nesm_2019_2020_5km_VEBF_2d_hslice_nt_', string(KmKe_2d_indxRange(1)), '_', string(KmKe_2d_indxRange(mean_Nt)), ...
    '_vlevel_', string(vlevel), '.nc');

uvw_file = strcat('../aghor_kmke/nesm_2019_2020_5km_uvw_annual_mean_3d_nt_', string(uvw_indxRange(1)), '_', string(uvw_indxRange(uvw_Nt)), '.nc');
%-------------------------------------------------------
...
figname  = [plots_path, 'rs_plots/vebf/nesm_2019_2020_5km_vebf_2d_hslice'];
