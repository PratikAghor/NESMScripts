...
if(strcmp(case_type, 'instant'))
    filename = strcat('nesm_2019_2020_5km_instant_VEBF_3d_nt_',string(nt), '.nc');

elseif(strcmp(case_type, 'avg'))
    filename = strcat('nesm_2019_2020_5km_VEBF_3d_nt_', string(indxRange(1)), '_', string(indxRange(Nt)), '.nc');
end
...
%%%%%%%%%%%%%%%%
if(strcmp(case_type, 'instant'))
    filename = strcat('nesm_2019_2020_5km_instant_VEBF_vslice_const_lat_nt_',string(nt), '.nc');

elseif(strcmp(case_type, 'avg'))
    filename = strcat('nesm_2019_2020_5km_VEBF_vslice_const_lat_nt_',string(indxRange(1)), '_', ...
