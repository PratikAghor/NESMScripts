...
if(strcmp(case_type, 'instant'))
    nt=3040;
    KmKe_2d_file = strcat('nesm_2019_2020_5km_instant_KmKe_2d_hslice_nt_', string(nt), ...
...
elseif(strcmp(case_type, 'avg'))
    ...
    KmKe_2d_file = strcat('nesm_2019_2020_5km_KmKe_2d_hslice_nt_', string(KmKe_2d_indxRange(1)), '_', string(KmKe_2d_indxRange(mean_Nt)), ...
        '_vlevel_', string(vlevel), '.nc');
    uvw_file = strcat('nesm_2019_2020_5km_uvw_annual_mean_3d_nt_', string(uvw_indxRange(1)), '_', string(uvw_indxRange(uvw_Nt)), '.nc');
end
...
if(strcmp(case_type, 'instant'))
    figname  = [plots_path, 'rs_plots/KmKe/nesm_2019_2020_5km_instant_KmKe_2d_hslice_boxes'];
...
elseif(strcmp(case_type, 'avg'))
    figname  = [plots_path, 'rs_plots/KmKe/nesm_2019_2020_5km_KmKe_2d_hslice'];
