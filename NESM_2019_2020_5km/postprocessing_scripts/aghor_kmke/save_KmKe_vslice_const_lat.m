...
filename = strcat('nesm_2019_2020_5km_KmKe_3d_nt_', string(indxRange(1)), '_', string(indxRange(Nt)), '.nc');
...
size(hrs_vslice)
%%%%%%%%%%%%%%%%
filename = strcat('nesm_2019_2020_5km_KmKe_vslice_const_lat_nt_', string(indxRange(1)), '_', string(indxRange(Nt)), '.nc');
