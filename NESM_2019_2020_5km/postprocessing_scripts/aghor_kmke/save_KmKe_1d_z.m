...
KmKe_3d_file = strcat('nesm_2019_2020_5km_KmKe_3d_zlevs_nt_', string(indxRange(1)), '_', string(indxRange(Nt)), '.nc');
...
for i = 1:length(box_arr)
    ...
    KmKe_filepath = strcat(filepath, 'kmke/nesm_2019_2020_5km_kmke_z_', box, '_nt_', string(indxRange(1)), '_', string(indxRange(Nt)),  '.asc');
    HRS_filepath = strcat(filepath, 'hrs/nesm_2019_2020_5km_hrs_z_' , box, '_nt_', string(indxRange(1)), '_', string(indxRange(Nt)),  '.asc');
    VRS_filepath = strcat(filepath, 'vrs/nesm_2019_2020_5km_vrs_z_', box, '_nt_', string(indxRange(1)), '_', string(indxRange(Nt)),  '.asc');
...
for i = 1:length(lat_arr)
    ...
    for j = 1:length(lon_arr)
        ...
        for k = 1:N
            ...
            filepath = strcat('../../../compare/energetics/KmKe_VEBF_vert/vslice/');
            KmKe_filepath = strcat(filepath, 'kmke/nesm_2019_2020_5km_kmke_z_lat_', string(lat_arr(i)), '_lon_', string(lon_arr(j)), '_nt_', string(indxRange(1)), '_', string(indxRange(Nt)),  '.asc');
            HRS_filepath = strcat(filepath, 'hrs/nesm_2019_2020_5km_hrs_z_lat_' , string(lat_arr(i)), '_lon_', string(lon_arr(j)), '_nt_', string(indxRange(1)), '_', string(indxRange(Nt)),  '.asc');
            VRS_filepath = strcat(filepath, 'vrs/nesm_2019_2020_5km_vrs_z_lat_', string(lat_arr(i)), '_lon_', string(lon_arr(j)), '_nt_', string(indxRange(1)), '_', string(indxRange(Nt)),  '.asc');
            save(sprintf(HRS_filepath), 'HRS1D', '-ascii');
            save(sprintf(VRS_filepath), 'VRS1D', '-ascii');
            save(sprintf(KmKe_filepath), 'KmKe1D', '-ascii');
            %--------------------------------------------------------------
