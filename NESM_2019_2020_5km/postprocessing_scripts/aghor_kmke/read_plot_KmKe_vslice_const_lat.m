...
%%
%-------------------------------------------------------
filename = strcat('nesm_2019_2020_5km_KmKe_vslice_const_lat_nt_',string(indxRange(1)), '_', ...
...
for i = 1:length(lat_idx_arr)
    ...
    figname  = [plots_path, 'rs_plots/hrs/nesm_2019_2020_5km_hrs_vslice'];
    ...
    % if(i == 1)
        ...
        %     filename = '../../../compare/KmKe/vslice/KmKe/nesm_2019_2020_5km_KmKe';
    ...
    set(figure1, 'Visible', 'off'); % stop pop-ups
    figname  = [plots_path, 'rs_plots/vrs/nesm_2019_2020_5km_vrs_vslice'];
    figname = strcat(figname, '_lat_', string(lat_arr(i)));
    figname = strcat(figname, '_nt_', string(indxRange(1)), '_', ...
    string(indxRange(Nt)));
    exportgraphics(figure1, strcat(figname, '.pdf'), 'ContentType', 'vector', 'Resolution',300); % remove extra white space, 2022a and above
    ...
    set(figure1, 'Visible', 'off'); % stop pop-ups
    figname  = [plots_path, 'rs_plots/KmKe/nesm_2019_2020_5km_KmKe_vslice'];
    figname = strcat(figname, '_lat_', string(lat_arr(i)));
    figname = strcat(figname, '_nt_', string(indxRange(1)), '_', ...
    string(indxRange(Nt)));
    exportgraphics(figure1, strcat(figname, '.pdf'), 'ContentType', 'vector', 'Resolution',300); % remove extra white space, 2022a and above
