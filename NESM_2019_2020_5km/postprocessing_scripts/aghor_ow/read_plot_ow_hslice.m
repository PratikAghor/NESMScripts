...
tskip = 1;
vlevel_skip = 50;
ow_t_filename = strcat('nesm_2019_2020_5km_ow_t_hslice_vlevel_', string(vlevel), '_nt_',string(indxRange(1)), '_', ...
    string(indxRange(Nt)), '.nc');
% u_t_filename = strcat('nesm_2019_2020_5km_u_t_hslice_vlevel_', string(vlevel), '_nt_',string(uv_indxRange(1)), '_', ...
%     string(uv_indxRange(uv_Nt)),'.nc');
% 
% v_t_filename = strcat('nesm_2019_2020_5km_v_t_hslice_vlevel_', string(vlevel), '_nt_',string(uv_indxRange(1)), '_', ...
%     string(uv_indxRange(uv_Nt)),'.nc');
% 
