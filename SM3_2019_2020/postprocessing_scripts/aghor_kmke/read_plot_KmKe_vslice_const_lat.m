...
%%
%-------------------------------------------------------
filename = strcat('sm3_2019_2020_KmKe_vslice_const_lat_nt_',string(indxRange(1)), '_', ...
...
for i = 1:length(lat_idx_arr)
    ...
    figname  = [plots_path, 'rs_plots/hrs/sm3_2019_2020_hrs_vslice'];
    ...
    % if(i == 1)
        ...
        %     filename = '../../../compare/KmKe/vslice/KmKe/sm3_2019_2020_KmKe';
    ...
    set(figure1, 'Visible', 'off'); % stop pop-ups
    figname  = [plots_path, 'rs_plots/vrs/sm3_2019_2020_vrs_vslice'];
    figname = strcat(figname, '_lat_', string(lat_arr(i)));
    figname = strcat(figname, '_nt_', string(indxRange(1)), '_', ...
    string(indxRange(Nt)));
    exportgraphics(figure1, strcat(figname, '.pdf'), 'ContentType', 'vector', 'Resolution',300); % remove extra white space, 2022a and above
    ...
    set(figure1, 'Visible', 'off'); % stop pop-ups
    figname  = [plots_path, 'rs_plots/KmKe/sm3_2019_2020_KmKe_vslice'];
    figname = strcat(figname, '_lat_', string(lat_arr(i)));
    figname = strcat(figname, '_nt_', string(indxRange(1)), '_', ...
    string(indxRange(Nt)));
    exportgraphics(figure1, strcat(figname, '.pdf'), 'ContentType', 'vector', 'Resolution',300); % remove extra white space, 2022a and above
