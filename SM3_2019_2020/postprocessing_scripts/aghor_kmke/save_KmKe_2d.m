...
KmKe_3d_file = strcat('sm3_2019_2020_KmKe_3d_nt_', string(indxRange(1)), '_', string(indxRange(Nt)), '.nc');
...
%
time=0;
fname = sprintf([dirHR, 'sm3_2019_2020_avg.%05d.nc'], time);
hisfile = fname;
...
filename = strcat('sm3_2019_2020_KmKe_2d_hslice_nt_',string(indxRange(1)), '_', ...
