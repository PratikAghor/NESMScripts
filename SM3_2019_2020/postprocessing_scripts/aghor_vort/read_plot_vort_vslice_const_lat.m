...
%-------------------------------------------------------
%%
vort_t_filename = strcat('sm3_2019_2020_vort_t_vslice_const_lat_nt_',string(indxRange(1)), '_', ...
...
for nt = 2098:tskip:Nt
    ...
    %%%
        ...
        figname  = [plots_path, 'vort_plots/vslice/const_lat/sm3_2019_2020_vort_vslice'];
