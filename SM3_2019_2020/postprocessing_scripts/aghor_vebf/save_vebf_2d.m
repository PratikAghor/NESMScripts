...
VEBF_3d_file = strcat('sm3_2019_2020_VEBF_3d_nt_', string(indxRange(1)), '_', string(indxRange(Nt)), '.nc');
...
filename = strcat('sm3_2019_2020_VEBF_2d_hslice_nt_',string(indxRange(1)), '_', ...
