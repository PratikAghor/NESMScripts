...
% indxRange=3088:3097; % Jan 15 - Jan 30, 2020
...
%%
lonval = -63.15;
vort_t_filename = sprintf('nesm_2019_2020_vort_t_vslice_const_lon_%.2f_nt_%d_%d.nc', lonval, indxRange(1), indxRange(end));
...
for nt = 1:Nt
    ...
    for j = 1:length(lon_arr)
        ...
        if (strcmp(sec, 'zoom')==true)
            figname  = [plots_path, 'vort_plus_one_plots/vslice/const_lon_zoom/nesm_2019_2020_vort_t_vslice'];
        elseif(strcmp(sec, 'nozoom')==true)
            figname  = [plots_path, 'vort_plus_one_plots/vslice/const_lon/nesm_2019_2020_vort_t_vslice'];
        end
        % 
