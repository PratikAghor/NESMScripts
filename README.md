...
* ```figs``` directory contains data (wherever possible) and scripts for plotting figures in the manuscript (data generated from ```postprocessing_scripts``` directory for each run)
